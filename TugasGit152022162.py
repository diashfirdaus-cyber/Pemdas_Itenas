...
for i in range(len(df)):
    df.at[i, 'Gaji'] = df.at[i, 'Gaji'] * 1.05

# Pertanyaan 2:
# Setelah perubahan dilakukan, tampilkan DataFrame yang sudah diperbarui dan berikan ringkasan perubahan yang telah terjadi.
print("DataFrame setelah diperbarui:")
print(df)
print("Ringkasan perubahan: Setiap gaji karyawan telah ditingkatkan sebesar 5%.")
...
print(df)
print("Ringkasan hasil: Karyawan-karyawan yang usianya di atas 30 tahun telah menerima peningkatan gaji tambahan sebesar 2%.")
